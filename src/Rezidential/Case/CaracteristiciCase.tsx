...
import "../../CssPages/CaracteristiciAp.css"; // Asigură-te că acest path este corect
...
const CaracteristiciCase: React.FC<Props> = ({ property }) => {
  ...
  // Add details for each specific category
  addDetail(
    "Bucatarie",
  ...
  // Add subcategories for finishes
  ...
  return (
    <>
      ...
      <div className={`property-details ${showDetails ? "show-details" : ""}`}>
        ...
        {showDetails && <div className="other-details">{otherDetails}</div>}
      </div>
    </>
  );
};

export default CaracteristiciCase;
